...
export type GetQuestionsQueryVariables = Exact<{
  ...
  mcqanswerFilter?: InputMaybe<String_Comparison_Exp>;
}>;
...
export type GetUserWorksheetsForOptionsQueryVariables = Exact<{
  userid: Scalars['String']['input'];
}>;
